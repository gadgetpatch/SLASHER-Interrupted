        ...
        vbox:
            ...
            hbox:
                ...
                ##vbox:
                    ##style_prefix "radio"
                    ##label _("Display")
                    ##textbutton _("Standard") action SetField(config, "screen_width", 1440), renpy.reset_physical_size, Preference("display", 1)
                    ##textbutton _("Widescreen") action SetField(config, "screen_width", 1920), renpy.reset_physical_size, Preference("display", 1)
